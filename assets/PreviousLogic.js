...
document.addEventListener('DOMContentLoaded', function () {
    //let breadToggle =
    let currentSliceObj
    let frameArray = document.getElementsByClassName('cueFrame')
              ...
              // setTimeout(()=>{
                  ...
                  passedDivs.forEach(div=>{
                      div.forEach(actualDiv=>{
                          // let currentSlice = document.getElementById(actualDiv)
                          getId(actualDiv)
                  ...
                  sandwich.content.forEach(layer=>{
                      ...
                      if(layerFixins == currentSliceObj){
                          ...
                          // layer.forEach(slice=>{
                              ...
                              //activate the css attribute associated with the id of the slice
                              //for each element of a
                              // /*************** */
                              // let divValues = (`${layerFixins}Divs`)
                              // console.log(`${divValues}`)
                              // tempCue.forEach(element =>{
                              //     document.getElementById(divValues).style.visibility ='visible'
                              // })
  
                              // tempCue.forEach(sandwich=>{layerSlice(sandwich.content[sandwich.slcIndex])})
                              tempCue.forEach(sandwich=>{
